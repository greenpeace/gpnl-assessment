...
/**
 * This file, in production, sets the parameters for a form which registers newsletter signups
 * It also contains the backend part of the ajax function which process the front end form
 */
...
function newsletter_form_process () {
    ...
    $literatuurcode = $_POST[ 'literaturecode' ];
